...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: pageMeta({ title: "Privacy Policy — Quick Auto Recovery", description: "How Quick Auto Recovery collects, uses and protects your personal information.", path: "/privacy-policy" }),
  ...
  return (
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16 text-muted-foreground space-y-4">
        <p>We respect your privacy. This policy explains what data we collect when you contact Quick Auto Recovery and how we use it.</p>
